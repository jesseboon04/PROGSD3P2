...
<form action="" method="post">
    ...
    <input type=number name="aantal" required placeholder="aantal" max="<?php echo 15 ?>" min="<?php echo 0?>" ><br><br>
...
if ($_POST['submit']) {
    ...
    echo"Gekozen Poduct en Totaal prijs:"; echo "<br>";
    echo "product:",$product; echo "<br>";
    echo "aantal producten:", $aantal;echo "<br>";
